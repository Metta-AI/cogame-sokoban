...
# Substitute: sokoban, coworld-sokoban, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-sokoban:ci)
#   SMOKE_SLUG                 game slug                        (sokoban)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/sokoban)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/sokoban-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-sokoban:ci}}"
slug="${SMOKE_SLUG:-sokoban}"
